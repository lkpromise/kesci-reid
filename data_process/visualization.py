...
import cv2
import numpy as np
query_a = "/home/liuk/data/kesci-fu/test/query_a"
gallery_a = "/home/liuk/data/kesci-fu/test/gallery_a"

with open("/home/liuk/code/kesci/outputs/result_1218_02.json",'r') as f:
    file = json.load(f)
    ...
    cv2.imwrite("result_1218_02.png",img_result)
